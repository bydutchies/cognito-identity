...
// ********** BEGIN MAATWERK **********
                    await user.StartWithAdminNoSrpAuthAsync(new InitiateAdminNoSrpAuthRequest()
// ********** EINDE MAATWERK **********
                    {
                      Password = password
        ...
        {
// ********** BEGIN MAATWERK **********
            return await RespondToTwoFactorChallengeAsync(user, code, ChallengeNameType.SOFTWARE_TOKEN_MFA, authWorkflowSessionId, cancellationToken).ConfigureAwait(false);
// ********** EINDE MAATWERK **********
        }
...
// ********** BEGIN MAATWERK **********
        ...
        /// <param name="authWorkflowSessionId">The ongoing Cognito authentication workflow id.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the AuthFlowResponse object linked to that authentication workflow.</returns>
        public virtual async Task<AuthFlowResponse> RespondToMfaSetupChallengeAsync(TUser user, string authWorkflowSessionId, CancellationToken cancellationToken)
        {
            return await RespondToMfaSetupChallengeAsync(user, ChallengeNameType.MFA_SETUP, authWorkflowSessionId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="authWorkflowSessionId">The ongoing Cognito authentication workflow id.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the AuthFlowResponse object linked to that authentication workflow.</returns>
        public virtual async Task<AuthFlowResponse> RespondToMfaSetupChallengeAsync(TUser user, ChallengeNameType challengeNameType, string authWorkflowSessionId, CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
            ...
            {
                AuthFlowResponse context =
                    await user.RespondToMfaSetupAsync(new RespondToMfaSetupRequest
                    {
                        SessionID = authWorkflowSessionId,
                        ChallengeNameType = challengeNameType
            ...
            {
                throw new CognitoServiceException("Failed to respond to Cognito mfa setup challenge.", e);
            }
        }

        public virtual async Task<AuthFlowResponse> RespondToPasswordChangeChallengeAsync(TUser user, string newPassword, string authWorkflowSessionId, CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
            ...
            {
                throw new CognitoServiceException("Failed to respond to Cognito password change challenge.", e);
            }
        }
// ********** EINDE MAATWERK **********
...
// ********** BEGIN MAATWERK **********
        public async Task<AssociateSoftwareTokenResponse> AssociateSoftwareTokenAsync(string session, string accessToken, CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
            ...
            return await _cognitoClient.AssociateSoftwareTokenAsync(softwareTokenRequest);
        }

        public async Task<VerifySoftwareTokenResponse> VerifySoftwareTokenAsync(string session, string accessToken, string code, CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
            ...
            return await _cognitoClient.VerifySoftwareTokenAsync(tokenRequest);
        }

        public async Task<SetUserMFAPreferenceResponse> SetUserMFAPreferenceAsync(string accessToken, bool enable, CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();

            var tokenRequest = new SetUserMFAPreferenceRequest
            {
                AccessToken = accessToken,
            ...
            return await _cognitoClient.SetUserMFAPreferenceAsync(tokenRequest);
        }
// ********** EINDE MAATWERK **********
        #endregion
