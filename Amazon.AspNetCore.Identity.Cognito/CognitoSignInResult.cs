...
// ********** BEGIN MAATWERK **********
        ...
        public static readonly CognitoSignInResult MfaSetupRequired = new CognitoSignInResult { RequiresMfaSetup = true };
// ********** EINDE MAATWERK **********
...
// ********** BEGIN MAATWERK **********
        /// <summary>
        ///  Returns a flag indication whether mfa setup is required.
        /// </summary>
        /// <returns>A flag indication whether mfa setup is required.</returns>
        public bool RequiresMfaSetup { get; protected set; }
// ********** EINDE MAATWERK **********
